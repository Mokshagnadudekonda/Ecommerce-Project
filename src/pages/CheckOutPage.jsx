                ...
                <div className='md:w-2/4'>
                    <div className='border p-2 mb-6'>
                        <div className='flex items-center justify-between' onClick={() => setBillingToggle(!billingToggle)}>
                            ...
                            {billingToggle ? <FaAngleDown className='cursor-pointer' /> : <FaAngleUp className='cursor-pointer' />}
                        </div>
                    ...
                    <div className='border p-2 mb-6'>
                        <div className='flex items-center justify-between' onClick={() => setShippingToggle(!shippingToggle)}>
                            ...
                            {shippingToggle ? <FaAngleDown className='cursor-pointer' /> : <FaAngleUp className='cursor-pointer' />}
                        </div>

                        <div className={`space-y-4 ${shippingToggle ? "" : "hidden"}`}>
                            <div>
                                <label htmlFor="" className='block text-gray-700'>Address</label>
                                <input type="text" name='name' placeholder='Enter Address' className='w-full px-3 py-2 border' onChange={(e) => setShippingInfo({ ...shippingInfo, address: e.target.value })} />
                            </div>

                            <div>
                                <label htmlFor="" className='block text-gray-700'>City</label>
                                <input type="email" name='email' placeholder='Enter City Name' className='w-full px-3 py-2 border' onChange={(e) => setShippingInfo({ ...shippingInfo, city: e.target.value })} />
                            </div>
                            <div>
                                <label htmlFor="" className='block text-gray-700'>Zip code</label>
                                <input type="text" name='phone' placeholder='Enter Zip Code' className='w-full px-3 py-2 border' onChange={(e) => setShippingInfo({ ...shippingInfo, zip: e.target.value })} />
                            </div>
                        </div>
                    </div>
                    <div className='border p-2 mb-6'>
                        ...
                        <div className={`space-y-4 ${paymentToggle ? "" : "hidden"}`}>
                            <div className='flex items-center mb-2'>
                                ...
                                <label htmlFor="" className='block text-gray-700'>Cash on Devlivery</label>
                            </div>
